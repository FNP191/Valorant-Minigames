...
function loadTriviaRound() {
    const trivia = [
        {q: "¿Cual es el nombre real de Viper?", "a": "sabine callas"},
        {q: "¿De que pais es originario Phoenix?", "a": "reino unido"},
        {"q": "¿Cual es la identidad legal de Jett?", "a": "han sunwoo"},
        {"q": "¿Que agente era cocinera antes de unirse al Protocolo?", "a": "jett"},
        {"q": "¿Cual es el nombre real de Sova?", "a": "sasha novikov"},
        {"q": "¿De donde proviene Sage?", "a": "china"},
        {"q": "¿Cual es el nombre real de Sage?", "a": "wei ling ying"},
        {"q": "¿Que agente es de origen marroqui y se llama Aamir?", "a": "cypher"},
        {"q": "¿Cual es el nombre real de Raze?", "a": "tayane alves"},
        {"q": "¿De que ciudad de Brasil es Raze?", "a": "salvador"},
        {"q": "¿Que agente fue bombero en Boston?", "a": "brimstone"},
        {"q": "¿Cual es el nombre real de Breach?", "a": "erik torsten"},
        {"q": "¿Que agente es de Australia y se llama Kirra Foster?", "a": "skye"},
        {"q": "¿Cual es el nombre real de Chamber?", "a": "vincent fabron"},
        {"q": "¿De que pais es originario Chamber?", "a": "francia"},
        {"q": "¿Que agente se llama Efia Danso y es de Ghana?", "a": "astra"},
        {"q": "¿Cual es la identidad real de Reyna?", "a": "zyanya mondragon"},
        {"q": "¿Que agente es de Filipinas y se llama Tala Valdez?", "a": "neon"},
        {"q": "¿Cual es el nombre real de Iso?", "a": "li zhao yu"},
        {"q": "¿De que pais proviene Harbor?", "a": "india"},
        {"q": "¿Que agente es un robot de una Tierra alternativa?", "a": "kay/o"},
        {"q": "¿Cual es el nombre real de Gekko?", "a": "mateo armendariz"},
        {"q": "¿De que ciudad de EE. UU. es Gekko?", "a": "los angeles"},
        {"q": "¿Que agente es de Noruega y se llama Iselin?", "a": "deadlock"},
        {"q": "¿Cual es el pais de origen de Clove?", "a": "escocia"},
        {"q": "¿Que agente es el lider oficial del Protocolo?", "a": "brimstone"},
        {"q": "¿Como se llama la organizacion enemiga de la Tierra Omega?", "a": "legion valorant"},
        {"q": "¿Que agente utiliza criaturas llamadas Dizzy y Wingman?", "a": "gekko"},
        {"q": "¿De que pais es originario Yoru?", "a": "japon"},
        {"q": "¿Que agente proviene de Estambul, Turquia?", "a": "fade"},
        {"q": "¿Que agente utiliza nanobots alemanes?", "a": "killjoy"},
        {"q": "¿Que numero de agente tiene asignado Killjoy?", "a": "04"},
        {"q": "¿Que agente es el numero 01?", "a": "brimstone"},
        {"q": "¿Cual es el numero de agente de Viper?", "a": "02"},
        {"q": "¿Que tipo de habilidad es gratuita cada ronda?", "a": "habilidad firma"},
        {"q": "¿Cuantos puntos de definitiva otorga un orbe?", "a": "1"},
        {"q": "¿Que agente puede revivir a un aliado?", "a": "sage"},
        {"q": "¿Como se llama la definitiva de Sova?", "a": "furia del cazador"},
        {"q": "¿Cuanto daño hace un disparo de la ulti de Sova?", "a": "80"},
        {"q": "¿Cual es la habilidad firma de Jett?", "a": "viento de cola"},
        {"q": "¿Que agente puede colocar una torreta automatica?", "a": "killjoy"},
        {"q": "¿Como se llama la definitiva de Killjoy?", "a": "bloqueo"},
        {"q": "¿Que agente puede suprimir habilidades enemigas?", "a": "kay/o"},
        {"q": "¿Como se llama el robot de Raze que explota?", "a": "boombot"},
        {"q": "¿Que agente tiene la definitiva Duelo de Honor 1v1?", "a": "iso"},
        {"q": "¿Cuanto tarda la Spike en detonar?", "a": "45 segundos"},
        {"q": "¿Cuanto se tarda en desactivar la Spike completa?", "a": "7 segundos"},
        {"q": "¿Cuanto tarda la Spike en plantarse?", "a": "4 segundos"},
        {"q": "¿Cuanto cuesta el rifle Vandal?", "a": "2900"},
        {"q": "¿Cual es el daño a la cabeza de la Vandal?", "a": "160"},
        {"q": "¿Cuanto cuesta la Phantom?", "a": "2900"},
        {"q": "¿Cual es el arma mas cara del juego?", "a": "operator"},
        {"q": "¿Cuanto daño hace el Operator al cuerpo?", "a": "150"},
        {"q": "¿Que arma secundaria es gratuita cada ronda?", "a": "classic"},
        ...
        {"q": "¿Cuantas rondas se necesitan para ganar una partida normal?", "a": "13"},
